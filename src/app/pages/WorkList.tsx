...
const getStatusIcon = (status: string) => {
 ...
 case "In Progress":
 return <Clock size={16} className="text-[var(--state-info)]" />;
 case "Queued":
 return <Circle size={16} className="text-[var(--muted-foreground)]" />;
 case "Warning":
 return <AlertCircle size={16} className="text-[var(--state-error)]" />;
 case "Shorted":
 return <XCircle size={16} className="text-[var(--state-fatal)]" />;
 default:
 return <AlertCircle size={16} className="text-[var(--muted-foreground)]" />;
 }
};
...
const getPriorityColor = (priority: string) => {
 switch (priority) {
 case "Critical":
 return "bg-[var(--state-error)]/10 text-[var(--state-error)] border-[var(--state-error)]/40/20";
 case "High":
 return "bg-[var(--state-warning)]/10 text-[var(--state-warning)] border-[var(--state-warning)]/40/20";
 case "Medium":
 return "bg-[var(--state-warning)]/10 text-[var(--state-warning)] border-[var(--state-warning)]/20";
 case "Low":
 return "bg-[var(--state-success-container)]/60 text-[var(--state-success)] border-[var(--state-success)]/20";
 default:
 return "bg-[var(--state-debug)]/10 text-[var(--muted-foreground)] border-zinc-500/20";
 }
};
...
export function WorkList() {
 ...
 <span className="text-[var(--state-warning)] text-sm font-medium">Hot</span>
 </div>
 ) : (
 ...
 return (
 <div className={`p-6 pt-0 transition-all duration-300 ${showDetailPanel ? 'mr-[900px]' : ''}`}>
 <PageHeader
 icon={<ClipboardList size={20} />}
 title="Work List"
 breadcrumbs={[
 { label: "Navigation", to: "/app/navigation" },
 { label: "Operations", to: "/app/navigation?section=operations" },
 { label: "Work" },
 ]}
 ...
 className="text-sm text-[var(--muted-foreground)] dark:text-[var(--muted-foreground)] hover:text-[var(--foreground)] transition-colors"
 >
 Clear All
 </button>
 )}
 ...
 <div className="relative">
 <label className="text-sm font-medium text-[var(--muted-foreground)]  mb-2 block">Priority</label>
 <div className="bg-[var(--surface-container)] text-[var(--foreground)] border-[var(--border)] border-[var(--border)]  rounded-lg p-2 min-h-[42px]">
 {/* Selected Items as Chips */}
 <div className="flex flex-wrap gap-1.5 mb-2">
 ...
 {selectedPriorities.has(priority) && <CheckCircle2 size={12} className="text-[var(--foreground)]" />}
 </div>
 ...
 {/* Time Range Filter */}
 <div className="mt-4">
 <label className="text-sm font-medium text-[var(--muted-foreground)]  mb-2 block">Time Range</label>
 <div className="bg-[var(--surface-container)] text-[var(--foreground)] border-[var(--border)] border-[var(--border)]  rounded-lg p-2 min-h-[42px]">
 ...
 {timeRange === range && <CheckCircle2 size={12} className="text-[var(--foreground)]" />}
 </div>
 {range === 'custom' ? (
 <div className="flex items-center gap-2">
 <Calendar size={12} />
 ...
 className="bg-[var(--surface-container)] text-[var(--foreground)] border-[var(--border)] border-[var(--border)]  rounded-lg px-3 py-2 text-sm text-[var(--foreground)]  placeholder-zinc-500 outline-none"
 />
 ...
 <button
 onClick={saveFilters}
 className="mt-4 px-4 py-2 bg-[var(--primary)] hover:bg-[var(--brand-accent-light)] text-[var(--primary-foreground)] rounded-lg transition-colors flex items-center gap-2"
 >
 <Save size={18} />
 ...
 <div className="mt-4 px-4 py-2 bg-[var(--primary)] hover:bg-[var(--brand-accent-light)] text-[var(--primary-foreground)] rounded-lg transition-colors flex items-center gap-2">
 ...
 <span className="text-xs text-[var(--muted-foreground)]">{totalFilterCount} applied</span>
 </div>
 {selectedTypes.size > 0 && (
 <div>
 <p className="text-xs font-medium text-[var(--muted-foreground)] mb-1.5">Type</p>
 <div className="flex flex-wrap gap-1.5">
 {Array.from(selectedTypes).map((type) => (
 <span key={type} className="inline-flex items-center px-2 py-1 bg-[var(--surface-container)] dark:bg-[var(--surface-container-high)] text-[var(--foreground)]  rounded text-xs">{type}</span>
 ))}
 </div>
 </div>
 )}
 ...
 <div>
 <p className="text-xs font-medium text-[var(--muted-foreground)] mb-1.5">Status</p>
 <div className="flex flex-wrap gap-1.5">
 {Array.from(selectedStatuses).map((status) => (
 <span key={status} className="inline-flex items-center gap-1.5 px-2 py-1 bg-[var(--surface-container)] dark:bg-[var(--surface-container-high)] text-[var(--foreground)]  rounded text-xs">{getStatusIcon(status)}{status}</span>
 ))}
 </div>
 </div>
 )}
 ...
 <div>
 <p className="text-xs font-medium text-[var(--muted-foreground)] mb-1.5">Priority</p>
 <div className="flex flex-wrap gap-1.5">
 {Array.from(selectedPriorities).map((priority) => (
 <span key={priority} className={`inline-flex items-center px-2 py-1 rounded text-xs font-medium border ${getPriorityColor(priority)}`}>{priority}</span>
 ))}
 </div>
 </div>
 )}
 ...
 <Calendar size={12} />
 {timeRange === 'custom' ? `${customStartDate || 'Start'} - ${customEndDate || 'End'}` : timeRange}
 </span>
 </div>
 </div>
 )}
 ...
 className={`bg-[var(--surface-container)] text-[var(--foreground)] border-[var(--border)] border-2 rounded-lg p-3 transition-all cursor-pointer ${
 isActive
 ? "border-[var(--primary)] dark:border-[var(--primary)] "
 ...
 <p className="text-[var(--muted-foreground)] text-xs">{stat.label}</p>
 ...
 <div className="flex items-center gap-3 bg-[var(--surface-container)] text-[var(--foreground)] border-[var(--border)] rounded-lg px-4 py-3 border-2 border-[var(--border)]  focus-within:border-[var(--primary)] dark:focus-within:border-[var(--primary)] transition-colors">
 {isAiCommand ? (
 ...
 <div className="absolute top-full left-0 right-0 mt-2 bg-[var(--surface-container)] text-[var(--foreground)] border-[var(--border)] border-[var(--border)]  rounded-lg z-50 overflow-hidden">
 <div className="p-2 border-b border-[var(--border)]  bg-[var(--surface-container)] text-[var(--foreground)] border-[var(--border)]">
 ...
 className="w-full px-4 py-3 text-left text-sm text-[var(--foreground)]  hover:bg-[var(--surface-container-low)] dark:hover:bg-[var(--surface-container-high)] transition-colors flex items-center gap-2"
 >
 <Sparkles size={14} className="text-[var(--primary)] dark:text-[var(--primary)]" />
 ...
 className="px-4 py-2 bg-[var(--surface-container)] dark:bg-[var(--card)] hover:bg-[var(--surface-container-high)] text-[var(--foreground)]  rounded-lg transition-colors flex items-center gap-2 border-[var(--border)] "
 >
 <X size={18} />
 ...
 {/* Data Grid */}
 <div className="bg-[var(--surface-container)] text-[var(--foreground)] border border-[var(--border)]  rounded-xl overflow-hidden">
 {isInitialState ? (
 ...
 <h3 className="text-[var(--foreground)]  text-2xl font-bold mb-3">Hi, I'm OPTO!</h3>
 ...
 className="px-5 py-2.5 bg-[var(--surface-container)] dark:bg-[var(--card)] hover:bg-[var(--surface-container-high)] text-[var(--foreground)]  rounded-lg transition-all border-[var(--border)]  hover:border-[var(--primary)] dark:hover:border-[var(--primary)] flex items-center gap-2 group"
 >
 <ListChecks size={18} className="text-[var(--muted-foreground)] group-hover:text-[var(--primary)] dark:group-hover:text-[var(--primary)] transition-colors" />
 <span>Show All</span>
 </button>
 <button
 ...
 className="px-5 py-2.5 bg-[var(--surface-container)] dark:bg-[var(--card)] hover:bg-[var(--surface-container-high)] text-[var(--foreground)]  rounded-lg transition-all border-[var(--border)]  hover:border-[var(--primary)] dark:hover:border-[var(--primary)] flex items-center gap-2 group"
 >
 <Loader2 size={18} className="text-[var(--muted-foreground)] group-hover:text-[var(--primary)] dark:group-hover:text-[var(--primary)] transition-colors" />
 ...
 className="px-5 py-2.5 bg-[var(--surface-container)] dark:bg-[var(--card)] hover:bg-[var(--surface-container-high)] text-[var(--foreground)]  rounded-lg transition-all border-[var(--border)]  hover:border-[var(--primary)] dark:hover:border-[var(--primary)] flex items-center gap-2 group"
 >
 <Calendar size={18} className="text-[var(--muted-foreground)] group-hover:text-[var(--primary)] transition-colors" />
 ...
 <div className="w-6 h-6 bg-[var(--surface-container)] text-[var(--foreground)] border-[var(--border)] rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
 <Sparkles size={14} className="text-[var(--primary)]" />
 </div>
 <div>
 <p className="font-medium text-[var(--foreground)] ">Ask me anything</p>
 <p className="text-sm text-[var(--muted-foreground)] dark:text-[var(--muted-foreground)]">Try "show processing items" or "show high priority work"</p>
 </div>
 </div>
 <div className="flex items-start gap-3 text-[var(--foreground)]">
 <div className="w-6 h-6 bg-[var(--surface-container)] text-[var(--foreground)] border-[var(--border)] rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
 ...
 <div>
 <p className="font-medium text-[var(--foreground)] ">Search for records</p>
 <p className="text-sm text-[var(--muted-foreground)] dark:text-[var(--muted-foreground)]">Type any keyword to find specific work items</p>
 </div>
 </div>
 <div className="flex items-start gap-3 text-[var(--foreground)]">
 <div className="w-6 h-6 bg-[var(--surface-container)] text-[var(--foreground)] border-[var(--border)] rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
 ...
 <div>
 <p className="font-medium text-[var(--foreground)] ">Use filters or tiles</p>
 <p className="text-sm text-[var(--muted-foreground)] dark:text-[var(--muted-foreground)]">Click stat tiles or use the Filter button for advanced options</p>
 </div>
 </div>
 </div>
 </div>
              ...
              <MasterTableHead type="actionable">
                <tr>
                  {orderedColumns.map((columnKey) => {
                    ...
                    const stickyClass = isPinned ? "bg-[var(--surface-container)] text-[var(--foreground)] border-r-2 border-[var(--border)]" : "";
                    ...
                    return (
                      <MasterTableTh
                        ...
                        type="actionable"
                        density="compact"
                        className={`cursor-pointer hover:text-[var(--foreground)] transition-colors ${stickyClass}`}
                        style={pinnedStyle}
                ...
                {paginatedData.map((item) => (
                  ...
                  >
                    {orderedColumns.map((columnKey) => {
                      const isPinned = workListPinnedColumns.includes(columnKey);
                      const pinnedStyle = isPinned ? getPinnedColumnStyle(columnKey) : {};
                      const stickyClass = isPinned ? "bg-[var(--surface-container-high)] text-[var(--foreground)] border-r-2 border-[var(--border)]" : "";
 ...
 <div className="w-16 h-16 bg-[var(--surface-container)] text-[var(--foreground)] border-[var(--border)] rounded-full flex items-center justify-center mx-auto mb-4">
 <Search size={24} className="text-[var(--muted-foreground)]" />
 </div>
 <h3 className="text-[var(--foreground)] text-lg font-medium mb-2">No items found</h3>
 <p className="text-[var(--muted-foreground)] text-sm">Try adjusting your search or filter criteria.</p>
 </div>
 )}
 </>
 )}
 ...
 currentPage === 1
 ? 'bg-[var(--surface-container)] dark:bg-[var(--card)] text-[var(--muted-foreground)] dark:text-[var(--muted-foreground)] cursor-not-allowed border-[var(--border)] '
 : 'bg-[var(--surface-container)] dark:bg-[var(--card)] hover:bg-[var(--surface-container-high)] text-[var(--foreground)] border-[var(--border)] '
 }`}
 >
 Previous
 </button>
 ...
 if (page === '...') {
 return (
 <span key={`ellipsis-${index}`} className="px-3 text-[var(--muted-foreground)]">
 ...
 </span>
 );
 }
 ...
 <>
        {/* Slide-out Panel */}
        <div className="fixed right-0 top-0 h-full w-[900px] bg-[var(--surface-container-low)] text-[var(--foreground)] border-l border-[var(--border)] shadow-2xl z-50 animate-in slide-in- duration-300 flex flex-col">
          {/* Header */}
          <div className="flex items-center justify-between p-6 border-b border-[var(--border)] bg-[var(--surface-container-low)]">
            <div>
              <h3 className="text-xl font-bold text-[var(--foreground)]">{selectedItem.workList}</h3>
              <p className="text-sm text-[var(--muted-foreground)] mt-1">Work Item Details</p>
            </div>
            <button
              onClick={() => {
                if (hasPendingChanges()) {
          ...
          {/* Tabs */}
          <div className="flex border-b border-[var(--border)] px-6 bg-[var(--surface-container-low)]">
 <button
 ...
 activeTab === "actions"
 ? "border-[var(--state-warning)] text-[var(--state-on-warning-container)] bg-[var(--state-warning-container)]"
 ...
 activeAction === "assign" ? "bg-[var(--primary)]" : "bg-[var(--surface-container-low)] dark:bg-[var(--surface-container-high)]"
 }`}>
 <Monitor size={16} className="text-[var(--foreground)]" />
 </div>
 <h5 className="text-base font-semibold text-[var(--foreground)] ">Assign</h5>
 </div>
 <p className="text-xs text-[var(--muted-foreground)] dark:text-[var(--muted-foreground)]">Assign workstation</p>
 {pendingAssignment && (
 <p className="text-xs text-[var(--state-warning)] mt-1">Changes pending</p>
 )}
 </button>
 ...
 <div className="flex items-center gap-2 mb-1">
 <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${
 activeAction === "cancel" ? "bg-[var(--state-error)]" : "bg-[var(--surface-container-low)] dark:bg-[var(--surface-container-high)]"
 }`}>
 <XCircle size={16} className="text-[var(--foreground)]" />
 </div>
 <h5 className="text-base font-semibold text-[var(--foreground)] ">Cancel</h5>
 </div>
 <p className="text-xs text-[var(--muted-foreground)] dark:text-[var(--muted-foreground)]">Cancel this work list</p>
 {pendingCancellation && (
 <p className="text-xs text-[var(--state-warning)] mt-1">Changes pending</p>
 )}
 </button>
 ...
 <p className="text-sm text-[var(--muted-foreground)] dark:text-[var(--muted-foreground)]">Please review the changes that will be applied</p>
 </div>
 </div>

 {/* Changes Summary */}
 <div className="bg-[var(--surface-container)] text-[var(--foreground)] border-[var(--border)] border-[var(--border)]  rounded-lg p-4 space-y-4">
 <div className="flex items-center justify-between pb-2 border-b border-[var(--border)] ">
 <span className="text-sm text-[var(--muted-foreground)] dark:text-[var(--muted-foreground)]">Work List:</span>
 ...
 <div className="space-y-2">
 <h6 className="text-sm font-semibold text-[var(--foreground)]  flex items-center gap-2">
 <XCircle size={16} className="text-[var(--state-error)]" />
 ...
 className="flex-1 px-6 py-3 bg-[var(--primary)] hover:bg-[var(--brand-accent-light)] text-[var(--primary-foreground)] rounded-lg font-medium transition-colors flex items-center justify-center gap-2"
 >
 <Check size={18} />
 Apply Changes
 </button>
 ...
 className="px-6 py-3 bg-[var(--surface-container-low)] dark:bg-[var(--surface-container-high)] hover:bg-[var(--surface-container-high)] text-[var(--foreground)] rounded-lg font-medium transition-colors"
 >
 Cancel
 </button>
 </div>
 ...
 <CheckCircle2 size={32} className="text-[var(--foreground)]" />
 </div>
 ...
 <p className="text-sm text-[var(--muted-foreground)] dark:text-[var(--muted-foreground)]">Select a workstation to assign this work list</p>
 </div>
 </div>

 {/* Current Work Item Info */}
 <div className="bg-[var(--surface-container)] text-[var(--foreground)] border-[var(--border)] border-[var(--border)]  rounded-lg p-4">
 ...
 <div className="flex items-center justify-between">
 <span className="text-sm text-[var(--muted-foreground)] dark:text-[var(--muted-foreground)]">Type:</span>
 <span className="text-sm font-medium text-[var(--foreground)] ">{selectedItem.type}</span>
 </div>
 <div className="flex items-center justify-between">
 <span className="text-sm text-[var(--muted-foreground)] dark:text-[var(--muted-foreground)]">Priority:</span>
 ...
 Select Sortbar <span className="text-[var(--state-error)]">*</span>
 </label>
 <div className="space-y-2">
 {mockWorkstations
 .filter(ws => ws.type === selectedItem.type)
 ...
 return (
 <div key={workstation.id} className="bg-[var(--surface-container-lowest)] dark:bg-[var(--surface-container)] border-[var(--border)]  rounded-lg overflow-hidden">
 {/* Workstation Row */}
 <div 
 className="p-4 cursor-pointer hover:bg-[var(--surface-container)] text-[var(--foreground)] border-[var(--border)] transition-colors"
 ...
 <div className="w-10 h-10 bg-[var(--surface-container-low)] dark:bg-[var(--surface-container-high)] rounded-lg flex items-center justify-center">
 <Monitor size={20} className="text-[var(--foreground)]" />
 </div>
 <div>
 <h6 className="text-sm font-semibold text-[var(--foreground)] ">{workstation.name}</h6>
 <p className="text-xs text-[var(--muted-foreground)] dark:text-[var(--muted-foreground)]">{workstation.zone} • {workstation.type}</p>
 </div>
 </div>
 <div className="flex items-center gap-2">
 ...
 <div className="bg-[var(--surface-container)] text-[var(--foreground)] border-[var(--border)] border-t border-[var(--border)]  p-4">
 <div className="mb-2 text-xs font-semibold text-[var(--muted-foreground)] uppercase tracking-wider">Sortbars</div>
 <div className="space-y-2">
 ...
 isSelected
 ? "border-[var(--primary)] bg-[var(--primary)]/10"
 : "border-[var(--border)]  bg-[var(--surface-container)] text-[var(--foreground)] border-[var(--border)] hover:border-[var(--border)] hover:bg-[var(--surface-container)] text-[var(--foreground)] border-[var(--border)]/70"
 }`}
 >
 <div className="flex items-center justify-between">
 <div className="grid grid-cols-4 gap-3 flex-1 text-sm">
 <div>
 <span className="text-[var(--muted-foreground)] text-xs block">Sortbar ID</span>
 <span className="text-[var(--foreground)] font-medium">{sortbar.id}</span>
 </div>
 <div>
 <span className="text-[var(--muted-foreground)] text-xs block">Status</span>
 <span className={`text-xs px-2 py-0.5 rounded inline-block ${
 sortbar.status === 'Active' ? 'bg-[var(--state-success-container)] text-[var(--state-success)]' : 'bg-[var(--state-debug)]/20 text-[var(--muted-foreground)]'
 }`}>
 {sortbar.status}
 </span>
 </div>
 <div>
 <span className="text-[var(--muted-foreground)] text-xs block">Container</span>
 <span className="text-[var(--foreground)]">{sortbar.container}</span>
 </div>
 <div>
 <span className="text-[var(--muted-foreground)] text-xs block">Trailer Type</span>
 <span className="text-[var(--foreground)]">{sortbar.trailerType}</span>
 </div>
 </div>
 {isSelected && (
 <div className="w-6 h-6 bg-[var(--primary)] rounded-full flex items-center justify-center ml-3">
 ...
 className="w-full bg-[var(--surface-container)] text-[var(--foreground)] border-[var(--border)] border-2 border-[var(--state-error)]/40/20 hover:border-[var(--state-error)]/40/40 rounded-lg p-6 text-left transition-all group"
 >
 <div className="flex items-center gap-3 mb-2">
 <div className="w-10 h-10 bg-[var(--state-error)]/20 group-hover:bg-[var(--state-error)]/30 rounded-lg flex items-center justify-center transition-colors">
 <XCircle size={20} className="text-[var(--state-error)]" />
 </div>
 <div>
 <h5 className="text-lg font-semibold text-[var(--foreground)] ">Cancel Work List</h5>
 <p className="text-sm text-[var(--muted-foreground)] dark:text-[var(--muted-foreground)]">Click to cancel this work list</p>
 </div>
 </div>

 {/* Current Work Item Info */}
 <div className="bg-[var(--surface-container)] text-[var(--foreground)] border-[var(--border)] border-[var(--border)]  rounded-lg p-4 mt-4">
 <h6 className="text-xs font-semibold text-[var(--muted-foreground)] mb-2">WORK ITEM TO CANCEL</h6>
 <div className="space-y-2">
 <div className="flex items-center justify-between">
 <span className="text-sm text-[var(--muted-foreground)] dark:text-[var(--muted-foreground)]">Work List:</span>
 <span className="text-sm font-medium text-[var(--foreground)] ">{selectedItem.workList}</span>
 ...
 <div className="flex items-center justify-between">
 <span className="text-sm text-[var(--muted-foreground)] dark:text-[var(--muted-foreground)]">Status:</span>
 <span className="text-sm font-medium text-[var(--foreground)] ">{selectedItem.status}</span>
 </div>
 </div>
 </div>
 </button>
 ...
 /* Cancellation Form */
 <div className="bg-[var(--surface-container)] text-[var(--foreground)] border-[var(--border)] border border-[var(--state-error)]/40/20 rounded-lg p-6 space-y-4">
 <div className="flex items-center gap-3 mb-4">
 ...
 <div>
 <h5 className="text-lg font-semibold text-[var(--foreground)] ">Cancel Work List</h5>
 <p className="text-sm text-[var(--muted-foreground)] dark:text-[var(--muted-foreground)]">Cancelling {selectedItem.workList}</p>
 </div>
 </div>
 ...
 rows={3}
 className="w-full px-4 py-3 bg-[var(--surface-container)] text-[var(--foreground)] border-[var(--border)] border-[var(--border)]  rounded-lg text-[var(--foreground)] placeholder-zinc-500 focus:outline-none focus: focus: focus:border-[var(--state-error)]/40 transition-all resize-none"
 />
 </div>

 {/* Warning Message */}
 <div className="bg-[var(--state-error)]/10 border border-[var(--state-error)]/40/20 rounded-lg p-4">
 ...
 <div className="sticky bottom-0 border border-[var(--primary)]/20 rounded-lg p-4">
 <div className="flex items-center justify-between">
 <div>
 <p className="text-sm font-semibold text-[var(--foreground)] ">You have pending changes</p>
 <p className="text-xs text-[var(--muted-foreground)] dark:text-[var(--muted-foreground)] mt-0.5">
 ...
 className="px-6 py-3 bg-[var(--primary)] hover:bg-[var(--brand-accent-light)] text-[var(--primary-foreground)] rounded-lg font-medium transition-colors flex items-center gap-2"
 >
 <Check size={18} />
 Apply Changes
 </button>
            ...
            <MasterTableContainer type="panel" className="bg-[var(--surface)] border border-[var(--border)] rounded-xl overflow-hidden">
              <MasterTable type="panel">
                <MasterTableBody type="panel">
                  <MasterTableRow type="panel">
                    <MasterTableCell type="panel" density="compact" className="font-medium text-[var(--muted-foreground)]">ID</MasterTableCell>
                    <MasterTableCell type="panel" density="compact">{selectedItem.id}</MasterTableCell>
                  </MasterTableRow>
                  <MasterTableRow type="panel">
                    <MasterTableCell type="panel" density="compact" className="font-medium text-[var(--muted-foreground)]">Work List</MasterTableCell>
                    <MasterTableCell type="panel" density="compact">{selectedItem.workList}</MasterTableCell>
                  </MasterTableRow>
                  <MasterTableRow type="panel">
                    <MasterTableCell type="panel" density="compact" className="font-medium text-[var(--muted-foreground)]">Type</MasterTableCell>
                    <MasterTableCell type="panel" density="compact">{selectedItem.type}</MasterTableCell>
                  </MasterTableRow>
                  <MasterTableRow type="panel">
                    <MasterTableCell type="panel" density="compact" className="font-medium text-[var(--muted-foreground)]">Status</MasterTableCell>
                    <MasterTableCell type="panel" density="compact">
                      <div className="flex items-center gap-2">
                        {getStatusIcon(selectedItem.status)}
                        <span className="text-sm text-[var(--foreground)]">{selectedItem.status}</span>
                      </div>
                    </MasterTableCell>
                  </MasterTableRow>
                  <MasterTableRow type="panel">
                    <MasterTableCell type="panel" density="compact" className="font-medium text-[var(--muted-foreground)]">Priority</MasterTableCell>
                    <MasterTableCell type="panel" density="compact">
                  ...
                  <MasterTableRow type="panel">
                    <MasterTableCell type="panel" density="compact" className="font-medium text-[var(--muted-foreground)]">Priority Date Time</MasterTableCell>
                    <MasterTableCell type="panel" density="compact">{selectedItem.priorityDateTime}</MasterTableCell>
                  </MasterTableRow>
                  <MasterTableRow type="panel">
                    <MasterTableCell type="panel" density="compact" className="font-medium text-[var(--muted-foreground)]">Hot Item</MasterTableCell>
                    <MasterTableCell type="panel" density="compact">
                      {selectedItem.isHot ? (
                        <div className="flex items-center gap-1.5">
                          <Flame size={16} className="text-[var(--state-warning)]" />
                          <span className="text-[var(--state-warning)] text-sm font-medium">Yes</span>
                        </div>
                      ) : (
                  ...
                  <MasterTableRow type="panel">
                    <MasterTableCell type="panel" density="compact" className="font-medium text-[var(--muted-foreground)]">Attribute 1</MasterTableCell>
                    <MasterTableCell type="panel" density="compact">{selectedItem.attribute1}</MasterTableCell>
                  </MasterTableRow>
                  <MasterTableRow type="panel">
                    <MasterTableCell type="panel" density="compact" className="font-medium text-[var(--muted-foreground)]">Attribute 2</MasterTableCell>
                    <MasterTableCell type="panel" density="compact">{selectedItem.attribute2}</MasterTableCell>
                  </MasterTableRow>
                  <MasterTableRow type="panel">
                    <MasterTableCell type="panel" density="compact" className="font-medium text-[var(--muted-foreground)]">Attribute 3</MasterTableCell>
                    <MasterTableCell type="panel" density="compact">{selectedItem.attribute3}</MasterTableCell>
                  </MasterTableRow>
                  <MasterTableRow type="panel">
                    <MasterTableCell type="panel" density="compact" className="font-medium text-[var(--muted-foreground)]">Attribute 4</MasterTableCell>
                    <MasterTableCell type="panel" density="compact">{selectedItem.attribute4}</MasterTableCell>
                  </MasterTableRow>
                  <MasterTableRow type="panel">
                    <MasterTableCell type="panel" density="compact" className="font-medium text-[var(--muted-foreground)]">Attribute 5</MasterTableCell>
                    <MasterTableCell type="panel" density="compact">{selectedItem.attribute5}</MasterTableCell>
                  </MasterTableRow>
                  <MasterTableRow type="panel">
                    <MasterTableCell type="panel" density="compact" className="font-medium text-[var(--muted-foreground)]">Sub Type</MasterTableCell>
                    <MasterTableCell type="panel" density="compact">{selectedItem.subType}</MasterTableCell>
                  </MasterTableRow>
                  <MasterTableRow type="panel">
                    <MasterTableCell type="panel" density="compact" className="font-medium text-[var(--muted-foreground)]">Started</MasterTableCell>
                    <MasterTableCell type="panel" density="compact">{selectedItem.started}</MasterTableCell>
                  </MasterTableRow>
                  <MasterTableRow type="panel">
                    <MasterTableCell type="panel" density="compact" className="font-medium text-[var(--muted-foreground)]">Storage</MasterTableCell>
                    <MasterTableCell type="panel" density="compact" className="font-mono">{selectedItem.storage}</MasterTableCell>
                  </MasterTableRow>
                  <MasterTableRow type="panel">
                    <MasterTableCell type="panel" density="compact" className="font-medium text-[var(--muted-foreground)]">Destination</MasterTableCell>
                    <MasterTableCell type="panel" density="compact">{selectedItem.destination}</MasterTableCell>
                  </MasterTableRow>
                  <MasterTableRow type="panel">
                    <MasterTableCell type="panel" density="compact" className="font-medium text-[var(--muted-foreground)]">Created</MasterTableCell>
                    <MasterTableCell type="panel" density="compact">{selectedItem.created}</MasterTableCell>
                  </MasterTableRow>
                  <MasterTableRow type="panel">
                    <MasterTableCell type="panel" density="compact" className="font-medium text-[var(--muted-foreground)]">Modified</MasterTableCell>
                    <MasterTableCell type="panel" density="compact">{selectedItem.modified}</MasterTableCell>
                  </MasterTableRow>
                </MasterTableBody>
              </MasterTable>
            </MasterTableContainer>
 ...
 step.completed
 ? 'bg-[var(--state-success-container)] border-[var(--state-success)]/30'
 ...
 {step.completed ? (
 <CheckCircle2 size={14} className="text-[var(--state-success-foreground)]" />
 ) : (
 <Circle size={10} className="text-[var(--foreground)]" />
 )}
 </div>
 <div className="flex-1 min-w-0">
 ...
 {step.completed && (
 <p className="text-xs text-[var(--primary)] mt-1">Completed</p>
 )}
 </div>
 </div>
 ))}
 ...
 {entry.workListId && (
 <div className="flex items-center gap-2">
 <span className="text-[var(--muted-foreground)]">Work List ID:</span>
 <span className="text-[var(--foreground)]  font-mono">{entry.workListId}</span>
 </div>
 )}
 {entry.ipAddress && (
 <div className="flex items-center gap-2">
 <span className="text-[var(--muted-foreground)]">IP Address:</span>
 <span className="text-[var(--foreground)]  font-mono">{entry.ipAddress}</span>
 </div>
 )}
 {entry.duration && (
 <div className="flex items-center gap-2">
 <span className="text-[var(--muted-foreground)]">Duration:</span>
 <span className="text-[var(--foreground)]  font-mono">{entry.duration}</span>
 </div>
 )}
 {entry.hostAdapterType && (
 <div className="flex items-center gap-2">
 <span className="text-[var(--muted-foreground)]">Type:</span>
 <span className="text-[var(--foreground)] ">{entry.hostAdapterType}</span>
 </div>
 )}
 ...
 <div className="space-y-6">
            ...
            <MasterTableContainer type="nested">
              <MasterTable type="nested">
                <MasterTableHead type="nested">
                  <tr>
                    <MasterTableTh type="nested" density="compact" className="sticky left-0 z-10 bg-[var(--surface-container)] text-[var(--foreground)] border-r border-[var(--border)]">Work Line</MasterTableTh>
                  ...
                  {mockWorkLines
                    ...
                    .map((workLine) => (
                      <MasterTableRow
                        ...
                        selected={selectedWorkLine === workLine.workLine}
                      >
                        <MasterTableCell type="nested" density="compact" className="font-medium sticky left-0 z-10 bg-[var(--surface-container-high)] text-[var(--foreground)]">{workLine.workLine}</MasterTableCell>
                        ...
                        <MasterTableCell type="nested" density="compact">{workLine.item}</MasterTableCell>
                        <MasterTableCell type="nested" density="compact" align="right">{workLine.quantity}</MasterTableCell>
                        <MasterTableCell type="nested" density="compact">
                          <div className="flex items-center gap-2">
                            {getStatusIcon(workLine.status)}
                            <span className="text-sm text-[var(--foreground)]">{workLine.status}</span>
                          </div>
                        </MasterTableCell>
                        <MasterTableCell type="nested" density="compact" className="text-[var(--muted-foreground)] dark:text-[var(--muted-foreground)]">{workLine.started || "-"}</MasterTableCell>
                        <MasterTableCell type="nested" density="compact" className="text-[var(--muted-foreground)] dark:text-[var(--muted-foreground)]">{workLine.comment || "-"}</MasterTableCell>
                      </MasterTableRow>
                    ))}
                </MasterTableBody>
              </MasterTable>
          ...
          <div>
            <h4 className="text-sm font-semibold text-[var(--foreground)]  mb-4 flex items-center gap-2">
              ...
              Work Operations
              {selectedWorkLine && (
                <span className="text-xs text-[var(--muted-foreground)] dark:text-[var(--muted-foreground)] font-normal">
                  ({selectedWorkLine})
                </span>
              )}
            </h4>
            {selectedWorkLine ? (
              <MasterTableContainer type="nested">
                <MasterTable type="nested">
                  <MasterTableHead type="nested">
                    <tr>
                      <MasterTableTh type="nested" density="compact" className="sticky left-0 z-10 bg-[var(--surface-container)] text-[var(--foreground)] border-r border-[var(--border)]">Work Operation</MasterTableTh>
                    ...
                    {mockWorkOperations
                      ...
                      .map((operation) => (
                        <MasterTableRow
                          ...
                          clickable={false}
                        >
                          <MasterTableCell type="nested" density="compact" className="font-medium sticky left-0 z-10 bg-[var(--surface-container-high)] text-[var(--foreground)]">{operation.workOperation}</MasterTableCell>
                          <MasterTableCell type="nested" density="compact">{operation.type}</MasterTableCell>
                          <MasterTableCell type="nested" density="compact">{operation.destinationLocation}</MasterTableCell>
                          <MasterTableCell type="nested" density="compact">{operation.sourceLocation}</MasterTableCell>
                          <MasterTableCell type="nested" density="compact">
                            <div className="flex items-center gap-2">
                              {getStatusIcon(operation.status)}
                              <span className="text-sm text-[var(--foreground)]">{operation.status}</span>
                            </div>
                          </MasterTableCell>
                          <MasterTableCell type="nested" density="compact" className="text-[var(--muted-foreground)] dark:text-[var(--muted-foreground)]">{operation.started || "-"}</MasterTableCell>
                          <MasterTableCell type="nested" density="compact" className="text-[var(--muted-foreground)] dark:text-[var(--muted-foreground)]">{operation.comment || "-"}</MasterTableCell>
                        </MasterTableRow>
                      ))}
                  </MasterTableBody>
                </MasterTable>
              ...
              <div className="bg-[var(--surface-container-lowest)] dark:bg-[var(--surface-container)] border border-[var(--border)] rounded-lg p-8 text-center">
                <ListChecks size={32} className="text-[var(--muted-foreground)] mx-auto mb-3" />
                <p className="text-sm text-[var(--muted-foreground)] dark:text-[var(--muted-foreground)]">Select a Work Line to view its operations</p>
              </div>
            )}
          </div>
        </div>
 ...
 <div className="bg-[var(--surface-container-high)] text-[var(--foreground)] p-6 rounded-lg w-96 border-[var(--border)] ">
 <div className="flex items-center gap-3 mb-4">
 ...
 <h3 className="text-xl font-bold text-[var(--foreground)] ">Unsaved Changes</h3>
 </div>
 <p className="text-sm text-[var(--muted-foreground)] dark:text-[var(--muted-foreground)] mb-6">
 You have pending changes that haven't been applied. What would you like to do?
 </p>
 <div className="flex flex-col gap-3">
 <button
 onClick={handleApplyChanges}
 className="w-full px-4 py-3 bg-[var(--primary)] hover:bg-[var(--brand-accent-light)] text-[var(--primary-foreground)] font-medium rounded-lg transition-colors flex items-center justify-center gap-2"
 >
 <Check size={18} />
 Apply Changes
 </button>
 ...
 className="w-full px-4 py-3 bg-[var(--state-error)] hover:bg-[var(--state-error-container)] text-[var(--state-error-foreground)] font-medium rounded-lg transition-colors flex items-center justify-center gap-2"
 >
 <XCircle size={18} />
 Discard Changes
 </button>
 ...
 className="w-full px-4 py-3 bg-[var(--surface-container-low)] dark:bg-[var(--surface-container-high)] hover:bg-[var(--surface-container-high)] text-[var(--foreground)] font-medium rounded-lg transition-colors"
 >
 Keep Editing
 </button>
 </div>
