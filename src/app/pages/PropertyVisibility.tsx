  ...
  return (
    ...
    >
      ...
      <div className="col-span-5 flex items-center gap-3">
        ...
        <div className="w-8 h-8 bg-zinc-700 rounded flex items-center justify-center text-xs text-zinc-400 font-mono">
          {index + 1}
        </div>
        <div>
          <p className="font-semibold text-white">{column.label}</p>
          <p className="text-xs text-zinc-500 font-mono">{column.id}</p>
        </div>
      </div>
      ...
      <div className="col-span-3 flex justify-center">
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all font-medium ${
            column.visible
              ? "bg-[#50e080] text-black hover:bg-[#3bc76a]"
      ...
      <div className="col-span-1 flex justify-end">
        {column.pinned && (
          <div className="w-2 h-2 bg-[#50e080] rounded-full"></div>
        )}
      </div>
    </div>
  );
  ...
  return (
    ...
    <div className="p-8">
      ...
      <div className="mb-4 flex items-center gap-2 text-sm text-zinc-500 dark:text-zinc-500">
        ...
        <ChevronRight size={14} />
        <Link to="/app/navigation?section=system" className="hover:text-[#0d9488] dark:hover:text-[#50e080] transition-colors">
          System
        </Link>
        <ChevronRight size={14} />
        <span className="text-zinc-900 dark:text-white font-medium">Property Visibility</span>
      </div>

      {/* Header */}
      <div className="mb-8 flex items-center justify-between">
        <div>
          <h2 className="text-3xl font-bold text-white mb-2">Property Visibility</h2>
          <p className="text-zinc-400">
            Manage column visibility and pinning for all grids in the system
          </p>
        </div>
        <div className="flex items-center gap-3">
          {hasUnsavedChanges && (
            <div className="flex items-center gap-2 text-amber-500 bg-amber-500/10 border border-amber-500/20 px-4 py-2 rounded-lg">
              <AlertCircle size={18} />
              <span className="text-sm font-medium">Unsaved Changes</span>
            </div>
          )}
          {showSaveSuccess && (
            <div className="flex items-center gap-2 text-[#50e080] bg-[#50e080]/10 border border-[#50e080]/20 px-4 py-2 rounded-lg animate-in fade-in duration-200">
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all ${
              hasUnsavedChanges
                ? "bg-[#50e080] hover:bg-[#3bc76a] text-black font-medium"
      ...
      <div className="grid grid-cols-12 gap-6">
        ...
        <div className="col-span-4 bg-zinc-900 border border-zinc-800 rounded-lg p-6">
          <div className="mb-4">
            <h3 className="text-lg font-semibold text-white mb-4">Select Grid</h3>
            ...
            <div className="relative mb-4">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 bg-zinc-800 border border-zinc-700 rounded-lg text-white placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-[#50e080] focus:border-transparent"
              />
            </div>
                ...
                <button
                  ...
                  className={`w-full text-left p-4 rounded-lg border-2 transition-all ${
                    selectedGrid === grid.id
                      ? "bg-[#50e080]/10 border-[#50e080] ring-2 ring-[#50e080]/30"
                      : "bg-zinc-800 border-zinc-700 hover:border-zinc-600 hover:bg-zinc-800/80"
                  }`}
                >
                  <div className="flex items-start justify-between gap-2">
                    <div className="flex-1">
                      <h4 className="font-semibold text-white mb-1">{grid.name}</h4>
                      <p className="text-sm text-zinc-400 mb-2">{grid.screen}</p>
                      <div className="flex gap-3 text-xs">
                        <span className="text-zinc-500">
                          {getVisibleColumnsCount(grid)}/{grid.columns.length} visible
                        </span>
                        {getPinnedColumnsCount(grid) > 0 && (
                          <span className="text-[#50e080]">
                            {getPinnedColumnsCount(grid)} pinned
                          </span>
                        )}
                      </div>
                    </div>
                    <div className="text-xs px-2 py-1 bg-zinc-700 text-zinc-300 rounded">
                      {grid.category}
                    </div>
                  </div>
                </button>
        ...
        <div className="col-span-8 bg-zinc-900 border border-zinc-800 rounded-lg p-6">
          {selectedGridConfig ? (
            <>
              {/* Header */}
              <div className="mb-6 pb-4 border-b border-zinc-800">
                <div className="flex items-center justify-between mb-2">
                  <div>
                    ...
                    <p className="text-sm text-zinc-400">{selectedGridConfig.screen}</p>
                  </div>
                  <button
                ...
                <div className="flex gap-4 text-sm">
                  <div className="flex items-center gap-2 text-zinc-400">
                    <Eye size={16} className="text-[#50e080]" />
                    <span>
                  ...
                  <div className="flex items-center gap-2 text-zinc-400">
                    <Pin size={16} className="text-[#50e080]" />
              ...
              {/* Column List */}
              <div className="space-y-2">
                <div className="grid grid-cols-12 gap-4 px-4 py-2 text-xs font-semibold text-zinc-500 uppercase tracking-wide">
              ...
              <div className="mt-6 p-4 bg-zinc-800/50 border border-zinc-700 rounded-lg">
                <div className="flex items-start gap-3">
                  <AlertCircle size={20} className="text-[#50e080] mt-0.5 flex-shrink-0" />
                  <div className="text-sm text-zinc-300">
                    <p className="font-semibold mb-1">How it works:</p>
                    <ul className="space-y-1 text-zinc-400">
                      <li>• <strong className="text-zinc-300">Drag and drop</strong> columns to reorder them</li>
                      <li>• <strong className="text-zinc-300">Visible columns</strong> are shown in the grid</li>
                      <li>• <strong className="text-zinc-300">Hidden columns</strong> are completely removed from view</li>
                      <li>• <strong className="text-zinc-300">Pinned columns</strong> stay fixed on the left side when scrolling horizontally</li>
